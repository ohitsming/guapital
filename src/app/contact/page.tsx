...
export default function Contact() {
    return (
        <>
            <PageIntro eyebrow="Contact us" title="Let us know what you think.">
                <p>Whether you&apos;re a business looking to run a market research, a user with feedback, 
                    or just curious about how LocalMoco works, we&apos;d love to hear from you. 
