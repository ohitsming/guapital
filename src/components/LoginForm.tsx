...
export function LoginForm() {
    ...
    const handleGoogleSignIn = async () => {
        ...
        const { error } = await supabase.auth.signInWithOAuth({
            provider: 'google',
            options: {
                redirectTo: `${location.origin}/api/supabase/auth/oauth`,
            },
        })
        if (error) {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                        ...
                        <div className="flex h-6 shrink-0 items-center">
                            <div className="group grid size-4 grid-cols-1">
                                <input
                                    ...
                                    name="remember-me"
                                    type="checkbox"
                                    className="col-start-1 row-start-1 appearance-none rounded border border-gray-300 bg-white checked:border-neutral-950 checked:bg-neutral-950 indeterminate:border-neutral-950 indeterminate:bg-neutral-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-950 disabled:border-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100 forced-colors:appearance-auto"
                                />
                                <svg
                                    fill="none"
                                    viewBox="0 0 14 14"
                    ...
                    <div className="text-sm/6">
                        <Link href="/login/forgot-password" className="font-semibold text-neutral-950 hover:text-neutral-700">
                            Forgot password?
                        </Link>
                    </div>
                </div>
